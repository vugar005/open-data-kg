...
@Component({
  selector: 'header-popup-new',
  templateUrl: './header-popup-new.component.html',
  styleUrls: ['./header-popup-new.component.scss']
})
export class HeaderPopupNewComponent implements OnInit {
  open: boolean;
